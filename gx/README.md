...
**[Sorcery Sans GX](https://github.com/twardoch/test-fonts/tree/master/gx/SorcerySansGX-OFL)** is a GX variation font based on Source Sans Pro, by Paul D. Hunt, Adobe Systems. A `.ttc` font collection is also available which implements an additional small-caps only font, created via the [pyftfeatfreeze](https://github.com/twardoch/fonttools-utils/tree/master/pyftfeatfreeze) tool.

### Zelcin GX

![Zelcin GX](./ZelcinGX-OFL/ZelcinGX.gif)

**[Zelcin GX](https://github.com/twardoch/test-fonts/tree/master/gx/ZelcinGX-OFL)** is a GX variation font based on Cinzel Decorative, by Natanael Gama, ndiscovered.com
